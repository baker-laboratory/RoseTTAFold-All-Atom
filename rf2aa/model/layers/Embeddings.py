...
from rf2aa.util_module import create_custom_forward, rbf, init_lecun_normal
from rf2aa.model.layers.Attention_module import Attention
...
class Templ_emb(nn.Module):
    ...
    def __init__(self, d_t1d=0, d_t2d=0, d_tor=0, d_pair=128, d_state=32, 
        ...
        self.templ_stack = TemplatePairStack(n_block=n_block, d_templ=d_templ, n_head=n_head, d_hidden=d_hidden, 
                                             d_t1d=d_t1d, d_state=d_state, p_drop=p_drop)
